...
#votre_film = df_film[df_film['tconst'] == id] # Variable qui stocke le film sur lequel se base la reco
...
def ml_recommandation(research_film) :
  ...
  df_reco = df_ml[df_ml.index != df_film_user.index[0]]
  ...
  try:
        ...
        recommandations = df_reco.iloc[reco_indices]['title_x']
